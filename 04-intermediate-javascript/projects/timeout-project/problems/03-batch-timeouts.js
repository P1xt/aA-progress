...
/**
 * It takes in an array of callbacks and an array of delays, and returns an array of timeout objects
 *
 * Args:
 *   callbacks: an array of functions to be called
 *   delays: an array of numbers, each number representing the delay in milliseconds before the
 * callback is called.
 *
 * Returns:
 *   An array of objects.
