...
function advancedExponent(b, n) {
  // base case, there are two base cases, when n is equal to zero and
  ...
  // recursive case
  // if n is even return advancedExponent(b, n / 2) ** 2
  // if n is odd return b * (advancedExponent(b, (n - 1) / 2) ** 2)
  if (n % 2 === 0) {
